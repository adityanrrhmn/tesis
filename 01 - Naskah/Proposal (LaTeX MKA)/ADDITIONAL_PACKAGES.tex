...
\usepackage{etoolbox}
\makeatletter
\patchcmd{\thealgorithm}{\thechapter}{\arabic{chapter}}{}{}
\makeatother

\usepackage{amssymb}  % Untuk simbol seperti \mathbb
\usepackage{mathtools} % Tambahan simbol
...
% Untuk grafik data (diagram batang & lingkaran/donat)
\usepackage{pgfplots}
